...
public final class DateConverter {
    ...
    // BS 2083 (index 113) verified against published calendar grids; see docs/calendar-data-2083.md.
    ...
    static var supportedBSYearRange: ClosedRange<Int> {
        bsYearZero...(bsYearZero + encodedMonthLengths.count - 1)
    }
